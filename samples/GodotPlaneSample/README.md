...
The next integration step is to replace the internal C# render snapshot string with a typed ABI or generated host-service binding, then extend the same bridge to mobile/Web export templates.
